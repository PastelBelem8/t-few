...
do
    ...
    python -m src.pl_train -c ${model}.json+pretrain.json+${dataset}.json -k load_weight="pretrained_checkpoints/${model}_ia3_finish.pt" save_model=True exp_name=${experiment_name} num_steps=1000
